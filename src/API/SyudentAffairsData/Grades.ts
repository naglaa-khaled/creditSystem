...
export const publishSemesterResults = async (
  ...
  try {
    const res = await axiosInstance.post(`Admin/publish-semester-results`, null, {
      params: {
        academicYear,
        semester,
        level,
...
export const getGrades = async (
  ...
  const res = await axiosInstance.get<IPreviewResponse>(
    "student-affairs/semester-results-by-level",
    {
      params: {
        academicYear,
        semester,
...
export const getStudentGrades = async (
  ...
  const res = await axiosInstance.get(`student-affairs/student-grades/${studentId}`, {
    params: {
      academicYear,
      semester,
    },
...
export const getCourseGrades = async (
  ...
  const res = await axiosInstance.get(`student-affairs/course-grades/${courseId}`, {
    params: {
      academicYear,
      semester,
    },
